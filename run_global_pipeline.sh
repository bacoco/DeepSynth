...
if [[ ! -f "deepsynth/pipelines/global_incremental_builder.py" ]]; then
    echo "❌ Error: deepsynth/pipelines/global_incremental_builder.py not found"
...
# Launch the pipeline
python -m deepsynth.pipelines.global_incremental_builder
