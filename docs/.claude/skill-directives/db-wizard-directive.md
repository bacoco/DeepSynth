# DB-WIZARD Skill Creation Directive
...
### Detection Summary
Detected 3 tasks related to database
...
```
.claude/skills/db-wizard/
├── SKILL.md (name: db-wizard, description, activation triggers)
...
Claude should activate db-wizard when:
